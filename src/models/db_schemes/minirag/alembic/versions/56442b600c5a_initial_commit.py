...
Revision ID: 56442b600c5a
Revises: 
Create Date: 2026-03-24 00:31:05.161342
...
def upgrade() -> None:
    ...
    op.create_index('ix_asset_project_id_index', 'assets', ['asset_project_id'], unique=False)
    op.create_index('ix_asset_type', 'assets', ['asset_type'], unique=False)
    op.create_table('chunks',
    sa.Column('datachunk_id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.PrimaryKeyConstraint('datachunk_id'),
...
def downgrade() -> None:
    ...
    op.drop_index('ix_asset_project_id_index', table_name='assets')
